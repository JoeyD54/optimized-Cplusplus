...
TEST(Mem14_combo_1, TestConfig::ALL)
{
#if Mem14_combo_1
	...
	// ----  GENERAL CHECK ------------------------------------------------------
	{
		...
		CHECK_EQUAL(h->peakNumUsed, 7);
		CHECK_EQUAL(h->peakUsedMemory, 0x1400);
		...
		// Prev
		CHECK_EQUAL(PTR_FIX(used->pUsedPrev), 0x740);
		// Next
		...
		// Prev
		CHECK_EQUAL(PTR_FIX(used->pUsedPrev), 0xa4c);
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0x434);
		...
		// Prev
		CHECK_EQUAL(PTR_FIX(used->pUsedPrev), 0xd58);
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0x740);
		...
		// Prev
		CHECK_EQUAL(PTR_FIX(used->pUsedPrev), 0x1164);
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0xa4c);
		...
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0xd58);
		...
		CHECK_EQUAL(free->mBlockSize, 0xb384);
		...
		CHECK_EQUAL(free->pFreePrev, nullptr);
		// Next
		CHECK_EQUAL(PTR_FIX(free->pFreeNext), 0x434);
		// Hdr Size
		...
		// Next
		CHECK_EQUAL(PTR_FIX(free->pFreeNext), 0xd58);
		...
		CHECK_EQUAL(PTR_FIX(hdrEnd), 0xd64);
		// Prev
		CHECK_EQUAL(PTR_FIX(free->pFreePrev), 0x434);
		// Next
		CHECK_EQUAL(PTR_FIX(free->pFreeNext), 0x1470);
		...
		CHECK_EQUAL(PTR_FIX(hdrEnd), 0x147c);
		// Prev
		CHECK_EQUAL(PTR_FIX(free->pFreePrev), 0xd58);
		// Next
		CHECK_EQUAL(free->pFreeNext, nullptr);
		...
		CHECK_EQUAL(PTR_FIX(free->pFreePrev), 0x434);
		// Next
		CHECK_EQUAL(PTR_FIX(free->pFreeNext), 0x15fc);
		...
		CHECK_EQUAL(PTR_FIX(hdrEnd), 0x1170);
		// Prev
		CHECK_EQUAL(PTR_FIX(used->pUsedPrev), 0x1470);
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0xa4c);
		...
		CHECK_EQUAL(used->pUsedPrev, nullptr);
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0x1164);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0xc800);
		CHECK_EQUAL(free->mBlockSize, 0xb1f8);
		...
		CHECK_EQUAL(h->peakNumUsed, 7);
		CHECK_EQUAL(h->peakUsedMemory, 0xbd80);
		...
		CHECK_EQUAL(PTR_FIX(free->pFreePrev), 0x434);
		// Next
		CHECK_EQUAL(PTR_FIX(free->pFreeNext), 0xc708);
		...
		CHECK_EQUAL(PTR_FIX(hdrEnd), 0x147c);
		// Prev
		CHECK_EQUAL(PTR_FIX(used->pUsedPrev), 0x15fc);
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0x1164);
		...
		CHECK_EQUAL(used->pUsedPrev, nullptr);
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0x1470);
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0xc800);
		CHECK_EQUAL(free->mBlockSize, 0xec);
		...
		CHECK_EQUAL(h->peakNumUsed, 7);
		CHECK_EQUAL(h->peakUsedMemory, 0xbfa0);
		...
		CHECK_EQUAL(used->pUsedPrev, nullptr);
		// Next
		CHECK_EQUAL(PTR_FIX(used->pUsedNext), 0x15fc);
		// Hdr Size
		CHECK_EQUAL(hdrEnd - hdrStart, sizeof(UsedHdr));
		...
		CHECK_EQUAL(PTR_FIX(blkStart), PTR_FIX(hdrEnd));
		CHECK_EQUAL(PTR_FIX(blkEnd), 0x740);
		CHECK_EQUAL(free->mBlockSize, 0xd4);
		...
		CHECK_EQUAL(PTR_FIX(hdrEnd), 0xd64);
		// Prev
		CHECK_EQUAL(PTR_FIX(free->pFreePrev), 0x660);
		// Next
		CHECK_EQUAL(PTR_FIX(free->pFreeNext), 0xc708);
