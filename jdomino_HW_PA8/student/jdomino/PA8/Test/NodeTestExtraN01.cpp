...
TEST_WITH_TEARDOWN(DeleteExtra01_Test_Enable, TestConfig::ALL)
{
#if DeleteExtra01_Test_Enable
	...
	//Node* pN30 = new Node(), * pN31 = new Node(), * pN32 = new Node(), * pN33 = new Node();
...
TEST_TEARDOWN(DeleteExtra01_Test_Enable)
{
