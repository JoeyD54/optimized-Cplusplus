...
#if MR_FAST
	// Need to change compiler settings AND update the settings document
	FILE_MODIFIED_CHECK(".\\..\\Benchmark\\Benchmark_MR_FAST_SETTINGS.txt",
		".\\PA5\\Benchmark\\Benchmark_MR_FAST_SETTINGS.txt", 0x50b87eac);
#endif
